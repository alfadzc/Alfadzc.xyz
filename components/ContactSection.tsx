    ...
    <section
      ...
      <div className="flex justify-center items-center gap-8">
        ...
        <a href="https://x.com/lfadzcc" target="_blank" rel="noopener noreferrer"
          className="flex items-center justify-center w-9 h-9 rounded-full bg-blue-500 hover:bg-blue-600 text-white transition">
        ...
        <a href="https://discord.com/users/940270226904318043" target="_blank" rel="noopener noreferrer"
          className="flex items-center justify-center w-9 h-9 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white transition">
        ...
        <a href="https://t.me/alfadzc" target="_blank" rel="noopener noreferrer"
          className="flex items-center justify-center w-9 h-9 rounded-full bg-[#0088cc] hover:bg-[#0077bb] text-white transition">
          <svg viewBox="0 0 24 24" fill="white" className="w-6 h-6">
        ...
        <a href="https://github.com/alfadzc" target="_blank" rel="noopener noreferrer"
          className="flex items-center justify-center w-9 h-9 rounded-full bg-gray-600 hover:bg-gray-300 text-white transition">
          <svg viewBox="0 0 24 24" fill="white" className="w-6 h-6">
